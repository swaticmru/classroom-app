...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        library=(ImageView)findViewById(R.id.lib);
        iat=(CardView)findViewById(R.id.iat2);
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Home.this, library.class);
                startActivity(i);
            }
        });
        iat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i1= new Intent(Home.this, iat2.class);
                startActivity(i1);
            }
        });
